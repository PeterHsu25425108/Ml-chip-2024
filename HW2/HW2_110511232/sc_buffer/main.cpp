...
int sc_main(int argc, char *argv[])
{
    ...
    sc_buffer<double> ***conv1_out = new sc_buffer<double> **[64];
    for (int i = 0; i < 64; i++)
    {
        conv1_out[i] = new sc_buffer<double> *[55];
        for (int j = 0; j < 55; j++)
        {
            conv1_out[i][j] = new sc_buffer<double>[55];
        }
    }

    sc_buffer<double> ***relu1_out = new sc_buffer<double> **[64];
    for (int i = 0; i < 64; i++)
    {
        relu1_out[i] = new sc_buffer<double> *[55];
        for (int j = 0; j < 55; j++)
        {
            relu1_out[i][j] = new sc_buffer<double>[55];
        }
    }

    sc_buffer<double> ***pool1_out = new sc_buffer<double> **[64];
    for (int i = 0; i < 64; i++)
    {
        pool1_out[i] = new sc_buffer<double> *[27];
        for (int j = 0; j < 27; j++)
        {
            pool1_out[i][j] = new sc_buffer<double>[27];
        }
    }

    sc_buffer<double> ***conv2_out = new sc_buffer<double> **[192];
    for (int i = 0; i < 192; i++)
    {
        conv2_out[i] = new sc_buffer<double> *[27];
        for (int j = 0; j < 27; j++)
        {
            conv2_out[i][j] = new sc_buffer<double>[27];
        }
    }

    sc_buffer<double> ***relu2_out = new sc_buffer<double> **[192];
    for (int i = 0; i < 192; i++)
    {
        relu2_out[i] = new sc_buffer<double> *[27];
        for (int j = 0; j < 27; j++)
        {
            relu2_out[i][j] = new sc_buffer<double>[27];
        }
    }

    sc_buffer<double> ***pool2_out = new sc_buffer<double> **[192];
    for (int i = 0; i < 192; i++)
    {
        pool2_out[i] = new sc_buffer<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            pool2_out[i][j] = new sc_buffer<double>[13];
        }
    }

    sc_buffer<double> ***conv3_out = new sc_buffer<double> **[384];
    for (int i = 0; i < 384; i++)
    {
        conv3_out[i] = new sc_buffer<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            conv3_out[i][j] = new sc_buffer<double>[13];
        }
    }

    sc_buffer<double> ***relu3_out = new sc_buffer<double> **[384];
    for (int i = 0; i < 384; i++)
    {
        relu3_out[i] = new sc_buffer<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            relu3_out[i][j] = new sc_buffer<double>[13];
        }
    }

    sc_buffer<double> ***conv4_out = new sc_buffer<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        conv4_out[i] = new sc_buffer<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            conv4_out[i][j] = new sc_buffer<double>[13];
        }
    }

    sc_buffer<double> ***relu4_out = new sc_buffer<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        relu4_out[i] = new sc_buffer<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            relu4_out[i][j] = new sc_buffer<double>[13];
        }
    }

    sc_buffer<double> ***conv5_out = new sc_buffer<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        conv5_out[i] = new sc_buffer<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            conv5_out[i][j] = new sc_buffer<double>[13];
        }
    }

    sc_buffer<double> ***relu5_out = new sc_buffer<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        relu5_out[i] = new sc_buffer<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            relu5_out[i][j] = new sc_buffer<double>[13];
        }
    }

    sc_buffer<double> ***pool5_out = new sc_buffer<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        pool5_out[i] = new sc_buffer<double> *[6];
        for (int j = 0; j < 6; j++)
        {
            pool5_out[i][j] = new sc_buffer<double>[6];
        }
    }

    sc_buffer<double> *flatten_out = new sc_buffer<double>[9216];
    sc_buffer<double> *fc1_out = new sc_buffer<double>[4096];
    sc_buffer<double> *relu6_out = new sc_buffer<double>[4096];
    sc_buffer<double> *fc2_out = new sc_buffer<double>[4096];
    sc_buffer<double> *relu7_out = new sc_buffer<double>[4096];
    sc_buffer<double> *fc3_out = new sc_buffer<double>[1000];
    ...
    sc_buffer<double> ***in_data = new sc_buffer<double> **[3];
    for (int i = 0; i < 3; i++)
    {
        in_data[i] = new sc_buffer<double> *[224];
        for (int j = 0; j < 224; j++)
        {
            in_data[i][j] = new sc_buffer<double>[224];
        }
    }

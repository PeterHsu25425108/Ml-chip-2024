...
int sc_main(int argc, char *argv[])
{
    ...
    sc_signal<double> ***conv1_out = new sc_signal<double> **[64];
    for (int i = 0; i < 64; i++)
    {
        conv1_out[i] = new sc_signal<double> *[55];
        for (int j = 0; j < 55; j++)
        {
            conv1_out[i][j] = new sc_signal<double>[55];
        }
    }

    sc_signal<double> ***relu1_out = new sc_signal<double> **[64];
    for (int i = 0; i < 64; i++)
    {
        relu1_out[i] = new sc_signal<double> *[55];
        for (int j = 0; j < 55; j++)
        {
            relu1_out[i][j] = new sc_signal<double>[55];
        }
    }

    sc_signal<double> ***pool1_out = new sc_signal<double> **[64];
    for (int i = 0; i < 64; i++)
    {
        pool1_out[i] = new sc_signal<double> *[27];
        for (int j = 0; j < 27; j++)
        {
            pool1_out[i][j] = new sc_signal<double>[27];
        }
    }

    sc_signal<double> ***conv2_out = new sc_signal<double> **[192];
    for (int i = 0; i < 192; i++)
    {
        conv2_out[i] = new sc_signal<double> *[27];
        for (int j = 0; j < 27; j++)
        {
            conv2_out[i][j] = new sc_signal<double>[27];
        }
    }

    sc_signal<double> ***relu2_out = new sc_signal<double> **[192];
    for (int i = 0; i < 192; i++)
    {
        relu2_out[i] = new sc_signal<double> *[27];
        for (int j = 0; j < 27; j++)
        {
            relu2_out[i][j] = new sc_signal<double>[27];
        }
    }

    sc_signal<double> ***pool2_out = new sc_signal<double> **[192];
    for (int i = 0; i < 192; i++)
    {
        pool2_out[i] = new sc_signal<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            pool2_out[i][j] = new sc_signal<double>[13];
        }
    }

    sc_signal<double> ***conv3_out = new sc_signal<double> **[384];
    for (int i = 0; i < 384; i++)
    {
        conv3_out[i] = new sc_signal<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            conv3_out[i][j] = new sc_signal<double>[13];
        }
    }

    sc_signal<double> ***relu3_out = new sc_signal<double> **[384];
    for (int i = 0; i < 384; i++)
    {
        relu3_out[i] = new sc_signal<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            relu3_out[i][j] = new sc_signal<double>[13];
        }
    }

    sc_signal<double> ***conv4_out = new sc_signal<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        conv4_out[i] = new sc_signal<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            conv4_out[i][j] = new sc_signal<double>[13];
        }
    }

    sc_signal<double> ***relu4_out = new sc_signal<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        relu4_out[i] = new sc_signal<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            relu4_out[i][j] = new sc_signal<double>[13];
        }
    }

    sc_signal<double> ***conv5_out = new sc_signal<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        conv5_out[i] = new sc_signal<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            conv5_out[i][j] = new sc_signal<double>[13];
        }
    }

    sc_signal<double> ***relu5_out = new sc_signal<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        relu5_out[i] = new sc_signal<double> *[13];
        for (int j = 0; j < 13; j++)
        {
            relu5_out[i][j] = new sc_signal<double>[13];
        }
    }

    sc_signal<double> ***pool5_out = new sc_signal<double> **[256];
    for (int i = 0; i < 256; i++)
    {
        pool5_out[i] = new sc_signal<double> *[6];
        for (int j = 0; j < 6; j++)
        {
            pool5_out[i][j] = new sc_signal<double>[6];
        }
    }
    ...
    sc_signal<double> ***in_data = new sc_signal<double> **[3];
    for (int i = 0; i < 3; i++)
    {
        in_data[i] = new sc_signal<double> *[224];
        for (int j = 0; j < 224; j++)
        {
            in_data[i][j] = new sc_signal<double>[224];
        }
    }
